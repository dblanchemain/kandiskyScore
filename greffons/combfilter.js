...
class combfilterNode extends AudioWorkletNode {

    constructor(context, baseURL, options) {
        super(context, 'combfilter', options);
    ...
    ctrlChange(channel, ctrl, value) {
        if (this.fCtrlLabel[ctrl] !== []) {
            for (var i = 0; i < this.fCtrlLabel[ctrl].length; i++) {
                ...
                this.setParamValue(path, combfilterNode.remap(value, 0, 127, this.fCtrlLabel[ctrl][i].min, this.fCtrlLabel[ctrl][i].max));
                if (this.output_handler) {
    ...
    pitchWheel(channel, wheel) {
        for (var i = 0; i < this.fPitchwheelLabel.length; i++) {
            ...
            this.setParamValue(pw.path, combfilterNode.remap(wheel, 0, 16383, pw.min, pw.max));
            if (this.output_handler) {
...
class combfilter {
    ...
    async load() {
        try {
            ...
            let real_url = (this.baseURL === "") ? "combfilter.wasm" : (this.baseURL + "/combfilter.wasm");
            ...
            if (this.fWorkletProcessors.indexOf(name) === -1) {
                try {
                    let re = /JSON_STR/g;
                    let combfilterProcessorString1 = combfilterProcessorString.replace(re, json);
                    let real_url = window.URL.createObjectURL(new Blob([combfilterProcessorString1], { type: 'text/javascript' }));
            ...
            this.node = new combfilterNode(this.context, this.baseURL,
                {
            ...
            this.node.onprocessorerror = () => { console.log('An error from combfilter-processor was detected.'); }
            return (this.node);
        } catch (e) {
            console.error(e);
            console.error("Faust " + this.name + " cannot be loaded or compiled");
            ...
            try {
                ...
                if (!this.linkExists(real_url)) {
                    ...
                    link.onload = (e) => {
                        ...
                        var element = createcombfilterGUI(this.node);
                        resolve(element);
                    }
                } else {
...
let combfilterProcessorString = `
    ...
    class combfilterProcessor extends AudioWorkletProcessor {
        ...
        static get parameterDescriptors() 
        {
            ...
            var params = [];
            combfilterProcessor.parse_ui(JSON.parse(\`JSON_STR\`).ui, params, combfilterProcessor.parse_item1);
            return params;
        }
...
const dspName5 = "combfilter";

// WAP factory or npm package module
if (typeof module === "undefined") {
    window.combfilter = combfilter;
    window.Faustcombfilter = combfilter;
    window[dspName5] = combfilter;
} else {
